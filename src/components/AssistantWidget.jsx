...
import jamesChatting from "../icons/james-chatting.svg";
        ...
        >
          ...
          <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-white flex-shrink-0">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-800">James</p>
          ...
          <div className="px-3 pb-3 pt-1 flex gap-2 items-end flex-shrink-0">
            <textarea
              ...
              rows={1}
              disabled={isTyping}
              className="flex-1 border border-slate-200 rounded-xl px-3 py-2 text-xs resize-none focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent disabled:opacity-60"
